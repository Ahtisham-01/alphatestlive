...
const SwiperSlide=dynamic(()=>import("swiper/react").then(res=>res.SwiperSlide),{ssr:false})
import { Autoplay } from "swiper"
import "swiper/css"
const Fade =dynamic(()=>import("react-awesome-reveal").then(res=>res.Fade),{ssr:false})
const HeroSection = () => {
    return (
        <>
            <div className="bg-black pt-[144px]">
                <Fade triggerOnce delay={500}>
                    <div className="flex justify-center items-center relative">
                        <div className="light-box absolute bottom-0 w-[563px] h-[563px] z-30 " />
                    </div>
                </Fade>
                <div className="">
                ...
                <div className="mt-[164px] border-t-zinc-700  border-t-[1px] border-b-zinc-700  border-b-[1px] w-full imgMain">
                    <div className="mx-auto container flex gap-[90px] w-full items-center justify-center max-w-[70%] my-[50px] bg-black imgDiv">
                        <img
