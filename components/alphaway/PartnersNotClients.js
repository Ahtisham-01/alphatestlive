    ...
    return (
        <>
            <div className="sticky top-1 border-t-[1px] border-zinc-700 h-[170vh]">
                <div
                    className={`flex w-full justify-between px-20 ${position <= 800 ? "block " : "hidden"
                        }`}
                >
                    ...
                    <div
                        className={`max-w-[768px] w-full pt-32 pb-[160px] pl-5 border-l-[1px] border-zinc-700 h-[100vh]`}
                    >
                        <Fade triggerOnce>
                ...
                <div
                    className={`flex w-full justify-between px-20 ${position >= 801 && position < 1099 ? "block" : "hidden"
                        }`}
                >
                    <div className={`max-w-[770px] w-full pt-32`}>
                        <Fade triggerOnce>
                ...
                <div
                    className={`flex w-full justify-between px-20 ${position >= 1100 && position < 1399 ? "block" : "hidden"
                        }`}
                >
                    <div className={`max-w-[770px] w-full pt-32`}>
                        <Fade triggerOnce>
                ...
                <div
                    className={`flex w-full justify-between px-20 ${position >= 1101 && position < 1699 ? "block" : "hidden"
                        }`}
                >
                    <div className={`max-w-[770px] w-full pt-32`}>
                        <Fade triggerOnce>
            ...
            <div
                className={`sticky top-1 h-[100vh] `}
            >
                <div
                    className={`flex w-full justify-between px-20  ${position <= 2600 ? "block" : "hidden"
                        }`}
                >
                    <div className={`max-w-[770px] w-full pt-32 `}>
                        <Fade triggerOnce>
                ...
                <div
                    className={`flex w-full justify-between px-20  ${position > 2601 && position <= 2900 ? "block" : "hidden"
                        }`}
                >
                    <div className={`max-w-[770px] w-full pt-32`}>
                        <Fade triggerOnce>
                ...
                <div
                    className={`flex w-full justify-between px-20   ${position > 2901 && position <= 3599 ? "block" : "hidden"
                        }`}
                >
                    <div className={`max-w-[770px] w-full pt-32 `}>
                        <Fade triggerOnce>
