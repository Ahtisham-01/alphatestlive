            ...
            <div className="bg-black boxes " ref={ref}>
                <div className={`w-full ${inView ? "box6" : ""} `}>
                    <div className={`${inView ? "box7" : ""}`}>
                        <div className="flex">
                            ...
                            <div
                                className={`px-20 pb-20 flex flex-col justify-end items-start h-[720px] ${inView ? "box8" : ""
                                    } min-w-[50%] relative`}
                            >
                                <div className="w-full video-container absolute top-0 left-0 ">
                                    <video
                ...
                {/* <div className="w-full">
                    <div className={`${inView ? "box10" : ""}`}>
                        <div className="flex ">
                            ...
                            <div
                                className={`px-20 pb-20 flex flex-col justify-end items-start h-[720px] ${inView ? "box11" : ""
                                    } min-w-[50%] relative`}
                            >
                                <div className="w-full video-container absolute top-0 left-0 ">
                                    <video
                ...
                <div className="w-full ">
                    <div className="flex ">
                        ...
                        <div
                            className={`relative flex justify-center items-center text-center ${inView ? "box12" : ""
                                } min-w-[50%]`}
                        >
                            <canvas
                                id="canvas"
