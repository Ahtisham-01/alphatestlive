            ...
            <div className="bg-black boxes" ref={ref}>
                <div className="relative ">
                    <div className={`flex w-full ${inView ? "box2" : ""}`}>
                        <div
                            className={`text-left pt-20 pl-20 min-w-[50%] pb-[312px] ${inView ? "box14" : ""
                                }`}
                        >
                        ...
                        <div
                            className={`text-right pt-20 pr-20 min-w-[50%] pb-[312px] ${inView ? "box4 box15" : ""
                                }`}
                        >
                            <h2 className="font-Archivo font-semibold text-6xl leading-[60px] text-zinc-300">
                                900,000+
                    ...
                    <div className={`flex w-full ${inView ? "box3" : ""}`}>
                        ...
                        <div
                            className={`pr-20 pb-20 pt-[312px] min-w-[50%] text-right ${inView ? "box13" : ""
                                }`}
                        >
                            <h2 className="font-Archivo font-semibold text-6xl leading-[60px] text-zinc-300">
                                29,000+
                    ...
                    <div className="mx-auto container relative flex justify-center items-center">
                        <div
                            className={`absolute hover:cursor-pointer top-[-550px] left-[33%] w-[490px] h-[144px] flex justify-center items-center bg-black ${inView ? "box" : ""
                                }`}
                        >
                            <button className=" bg-black flex flex-col justify-center items-center">
                                <span className="basement-bold uppercase font-extrabold text-[32px] leading-none text-center text-zinc-400">
                                By the numbers
                                </span>
